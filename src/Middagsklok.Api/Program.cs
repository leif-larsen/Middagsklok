...
using Middagsklok.Api.Features.Dishes.Retire;
using DishesRetireUseCase = Middagsklok.Api.Features.Dishes.Retire.UseCase;
...
using Middagsklok.Api.Features.Ingredients.OdaMappings.Delete;
using Middagsklok.Api.Features.Ingredients.OdaMappings.Overview;
using Middagsklok.Api.Features.Ingredients.OdaMappings.Upsert;
...
using Middagsklok.Api.Features.Recipes.SaveFromSuggestion;
...
using IngredientsOdaMappingDeleteUseCase = Middagsklok.Api.Features.Ingredients.OdaMappings.Delete.UseCase;
using IngredientsOdaMappingsOverviewUseCase = Middagsklok.Api.Features.Ingredients.OdaMappings.Overview.UseCase;
using IngredientsOdaMappingUpsertUseCase = Middagsklok.Api.Features.Ingredients.OdaMappings.Upsert.UseCase;
...
using RecipesSaveFromSuggestionUseCase = Middagsklok.Api.Features.Recipes.SaveFromSuggestion.UseCase;
...
builder.Services.AddScoped<DishesRetireUseCase>();
...
builder.Services.AddScoped<IngredientsOdaMappingDeleteUseCase>();
builder.Services.AddScoped<IngredientsOdaMappingsOverviewUseCase>();
builder.Services.AddScoped<IngredientsOdaMappingUpsertUseCase>();
...
builder.Services.AddScoped<RecipesSaveFromSuggestionUseCase>();
...
IngredientsOdaMappingDeleteEndpoint.Map(app);
IngredientsOdaMappingsOverviewEndpoint.Map(app);
IngredientsOdaMappingUpsertEndpoint.Map(app);
IngredientsOverviewEndpoint.Map(app);
IngredientsUpdateEndpoint.Map(app);
RecipesInstructionsEndpoint.Map(app);
RecipesSaveFromSuggestionEndpoint.Map(app);
