...
namespace Middagsklok.Api.Database.Migrations
{
    ...
    [Migration("20260917130546_AddIngredientOdaMapping")]
    partial class AddIngredientOdaMapping
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Middagsklok.Api.Domain.DishHistory.DishConsumptionEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("DishId", "EatenOn")
                        .IsUnique()
                        .HasDatabaseName("ix_dish_consumption_events_dish_id_eaten_on");

                    b.ToTable("dish_consumption_events", (string)null);
                });
            ...
            modelBuilder.Entity("Middagsklok.Api.Domain.Settings.PlanningSettings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Middagsklok.Api.Domain.DishHistory.DishConsumptionEvent", b =>
                {
                    b.HasOne("Middagsklok.Api.Domain.Dish.Dish", null)
                        .WithMany()
                    ...
                    b.HasOne("Middagsklok.Api.Domain.WeeklyPlan.WeeklyPlan", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Middagsklok.Api.Domain.Ingredient.Ingredient", b =>
                {
                    b.OwnsOne("Middagsklok.Api.Domain.Ingredient.OdaProductMapping", "OdaMapping", b1 =>
                        {
                            b1.Property<Guid>("ingredient_id")
                                .HasColumnType("uuid");
                            ...
                            b1.Property<int?>("OdaProductId")
                                .HasColumnType("integer")
                                .HasColumnName("oda_product_id");

                            b1.Property<string>("OdaProductName")
                                .HasMaxLength(300)
                                .HasColumnType("character varying(300)")
                                .HasColumnName("oda_product_name");

                            b1.Property<double?>("PackQuantity")
                                .HasColumnType("double precision")
                                .HasColumnName("pack_quantity");

                            b1.Property<string>("PackUnit")
                                .HasMaxLength(10)
                                .HasColumnType("character varying(10)")
                            ...
                            b1.HasKey("ingredient_id");

                            b1.HasIndex("OdaProductId")
                                .HasDatabaseName("ix_ingredient_oda_products_oda_product_id");

                            b1.ToTable("ingredient_oda_products", (string)null);

                            b1.WithOwner()
                                .HasForeignKey("ingredient_id");
                        });

                    b.Navigation("OdaMapping");
                });
