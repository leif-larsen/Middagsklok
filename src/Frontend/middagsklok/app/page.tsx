...
export default function Home() {
  ...
  return (
    <div className="min-h-screen w-full p-6 sm:p-8">
      <aside
        className={`menu-shell flex min-h-[calc(100vh-3rem)] flex-col rounded-[28px] border border-[#e2e8dc] bg-[#fbfcf7]/90 shadow-[0_18px_40px_-28px_rgba(20,45,28,0.35)] backdrop-blur transition-[width] duration-300 ${
      ...
      >
        ...
        <nav id="primary-navigation" className="mt-6 flex-1 px-3">
              ...
              return (
                <li key={item.label} className="menu-item" style={itemStyle}>
                  <button
                    ...
                    className={`group flex w-full items-center rounded-2xl px-3 py-2.5 text-sm font-semibold transition ${
                      collapsed
